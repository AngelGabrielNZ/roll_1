...
while comp_score < game_goal and user_score < game_goal:
    ...
    # switch the user and computer points if computer went first
    if first == "computer":
    ...
    if user_points > comp_points:
        ...
        loser = "user"
        user_points = 0
    round_feedback = f"The {winner} won. The {loser} points have been reset to zero"
    ...
    # Outside rounds Loop - Update score with round points, only add to the score of the
    ...
    print("*** Game Update ***")  # replace with call statement generator
...
if user_score > comp_score:
    make_statement(statement="The user won", decoration="👍")  # replace this statement generator
else:
